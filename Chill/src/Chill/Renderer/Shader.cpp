...
namespace Chill {
	...
	Chill::Ref<Chill::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	Chill::Ref<Chill::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
	...
	Chill::Ref<Chill::Shader> ShaderLibrary::Get(const std::string& name)
	{
